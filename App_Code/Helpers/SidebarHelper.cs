    ...
    public class SidebarHelper
    {
        public static string Build(string active, string role)
        {
            ...
            if (!isStaff)
            {
                ...
                sb.Append("<a href='../Products/Default.aspx' class='" + (active == "products" ? "active" : "") + "'>商品管理</a>");
                sb.Append("<a href='../Categories/Default.aspx' class='" + (active == "categories" ? "active" : "") + "'>分类管理</a>");
                sb.Append("<a href='../Suppliers/Default.aspx' class='" + (active == "suppliers" ? "active" : "") + "'>供应商管理</a>");
                sb.Append("<a href='../Customers/Default.aspx' class='" + (active == "customers" ? "active" : "") + "'>客户管理</a>");
                ...
                sb.Append("<a href='../Users/Default.aspx' class='" + (active == "users" ? "active" : "") + "'>用户管理</a>");
            }

            sb.Append("<div class='menu-title'>门店业务</div>");
            sb.Append("<a href='../Cart/Default.aspx' class='" + (active == "cart" ? "active" : "") + "'>购物车</a>");
